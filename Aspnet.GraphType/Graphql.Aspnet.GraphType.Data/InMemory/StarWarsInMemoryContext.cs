...
namespace Graphql.Aspnet.GraphType.Data.InMemory
{
    public class StarWarsInMemoryContext
    {
        ...
        public StarWarsInMemoryContext(ILogger<StarWarsInMemoryContext> logger)
        {
            _logger = logger;
