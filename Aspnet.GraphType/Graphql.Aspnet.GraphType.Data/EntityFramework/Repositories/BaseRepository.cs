...
namespace Graphql.Aspnet.GraphType.Data.EntityFramework.Repositories
{
        ...
        where TEntity : class, IEntity<TKey>, new()
    {
        ...
        {
            _logger.LogInformation("Get all {type}s (including [{includes}])", typeof(TEntity).Name,
        ...
        {
            _logger.LogInformation("Get {type} with id = {id} (including {include})", typeof(TEntity).Name, id,
                include);
